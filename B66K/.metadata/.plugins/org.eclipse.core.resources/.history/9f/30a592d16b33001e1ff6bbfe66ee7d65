...
<body>
	...
	<div
		style="background-color: yellow; width: 50px; height: 50px; border: 1px solid gray; border-radius: 50px; display: inline; float: right;">
					...
					<div class="btnBox">
						<div class="favoritBox">
							<button class="FavoritBtn" data-bno="${bdto.bvo.bno}">
								<span class="material-symbols-outlined bg"> favorite </span>
							</button>
	...
	<div id="reviewPopup">
		<div class="reviewPopup_content">
			<div class="reviewPopupModalTitle" id="reviewPopupModalTitle">
				<div id="modalMessage"></div>
				<div class="reviewPopupCloseBtn">
					<p class="reviewPopupCloseText">확인</p>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		const userUpdatePopup = document.getElementById("reviewPopup");
		...
		document.querySelector(".reviewPopupCloseBtn").addEventListener(
				"click", closePopup);
	</script>
