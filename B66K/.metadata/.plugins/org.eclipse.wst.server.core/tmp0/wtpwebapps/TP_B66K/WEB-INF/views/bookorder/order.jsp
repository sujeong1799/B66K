	...
	<div class="all" align="center">
		...
		<div class="wrapper">
				...
				<div class="userDetail" align="left">
					...
					<form action="/bookorder/order" name="check_submit" method="post">
						...
						<table class="usertable">
							...
							<tr>
								<th>우편번호</th>
								<th><input type="text" id="sample4_postcode"
									placeholder="우편번호" name="addressCode"> <input
									id="addBtn" type="button" onclick="sample4_execDaumPostcode()"
									value="우편번호 찾기"></th>
							</tr>

							<tr>
								<th>도로명주소</th>
								<th><input type="text" id="sample4_roadAddress"
									placeholder="도로명주소" name="addressJuso"></th>
							</tr>
							...
							<tr>
								...
								<th><input type="text" id="sample4_detailAddress"
									placeholder="나머지 주소를 입력하세요." name="addressDetail"></th>
							</tr>
             ...
             0
               ...
               3000
								...
								<div class="totalPriceValue" id="total_div">
									<c:if test="${total>15000}">결제금액 : <fmt:formatNumber
											value="${total}" />
									</c:if>
									<c:if test="${total<15000}">결제금액 : <fmt:formatNumber
											value="${total+3000}" />
         ...
         <button type="button" id="submitBtn">결제하기</button>   
							...
							<div class="payDiv2">
								<div class="btn-wrap" id="submitBtn">
									<a class="paybtn"> <span class="button-overlay"></span> <span
										class="button-text">결제하기</span>
									</a>
								</div>
							</div>
