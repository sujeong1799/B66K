                  ...
                  <table class="table orderDeatilTable">
                     ...
                     <tbody>
                        <c:forEach items="${bodto.boidto}" var="items">
                           <tr align="center">
                              <td><a href="/book/ProductDetail?bno=${items.boivo.bno }"><img class="orderDetailImg" alt="사진없음"
   ...
   <div class="modal fade" id="confirm" tabindex="-1"
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body" align="center">주문을 취소하시겠습니까?</div>
            <div class="modal-footer">
               <a href="/bookorder/cancle?ono=${bodto.bovo.ono}"><button
                     type="button" class="yesBtn">예</button></a>
               <button type="button" class="noBtn" data-bs-dismiss="modal">아니오</button>
            </div>
         </div>
      </div>
   </div>
            ...
            <form action="/bookorder/modify" method="post">
               <div class="modal-body">
                  ...
                  <input type="text" name="name"
                   value="${bodto.bovo.name}" class="recipientNameInput"><br> 
                  </div>
                  ...
                  <input type="text" id="sample4_postcode" placeholder="우편번호"
                     name="addressCode" class="postCodeInput" 
                     value="${bodto.bovo.addressCode}" readonly>
                  <input type="button" onclick="sample4_execDaumPostcode()"
                     value="우편번호 찾기" class="findPostCode">
                   </div>  
                  ...
                  <div class="roadAddress">
                    <span>도로명주소</span>
                     ...
                     placeholder="도로명주소" class="roadAddressInput"
                     name="addressJuso" value="${bodto.bovo.addressJuso}" 
                     readonly>
                  </div>
                  ...
                  <input type="text" id="sample4_jibunAddress"
                     placeholder="지번주소" readonly class="landAddressInput"><br>
                      <span id="guide"
                   ...
                   <span>상세주소</span>
                     ...
                     <input
                      type="text" id="sample4_detailAddress" class="detailAddressInput"
                      placeholder="상세주소" name="addressDetail" 
                      value="${bodto.bovo.addressDetail}">
                   </div> 
                   
                   <div class="deliveryRequest">
                   <p>요청사항</p>
                  <textarea rows="10" cols="55" name="etc" style="resize: none"
                  class="deliveryRequestInput">${bodto.bovo.etc}</textarea>
                   </div>
               ...
               <div class="modal-footer">
                  <button type="button" class="modalNo" data-bs-dismiss="modal">취소하기</button>
