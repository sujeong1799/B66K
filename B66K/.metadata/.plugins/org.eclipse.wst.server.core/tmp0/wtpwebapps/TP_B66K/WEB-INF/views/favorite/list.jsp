      ...
      <div class="favoriteContent">
         ...
         <div class="favoriteBox">
            <div class="favoriteDetailText">
               <p class="favoritedetailText">찜목록</p>
         ...
         <c:if test="${favoritelist_msg ne '0'}">
            <c:forEach items="${list}" var="fdto">
               <tr data-fno="${fdto.fvo.fno}">
                  ...
                  <th><a href="/book/ProductDetail?bno=${fdto.fvo.bno}" class="bookTitle">${fdto.fvo.title}</a></th> 
                  <th><a href="/book/ProductDetail?bno=${fdto.fvo.bno}">${fdto.fvo.author}</a></th> 
